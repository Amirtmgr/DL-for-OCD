...
class DimFeatureExtractor(nn.Module):
    def __init__(
            self,
            input_dim,
            hidden_dim,
        ...
        super(DimFeatureExtractor, self).__init__()
...
class DimAttendAndDiscriminate(nn.Module):
    def __init__(
            self,
            channels,
            classes,
        ...
        super(DimAttendAndDiscriminate, self).__init__()
        self.gpu = gpu
        self.hidden_dim = hidden_dim

        self.fe = DimFeatureExtractor(
            channels,
            hidden_dim,
            conv_kernels,
            conv_kernel_size,
